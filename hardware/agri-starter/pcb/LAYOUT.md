...
| Board size | **110.2 x 87.3 mm** (doc target 80 x 60 mm) |
...
| Routing | autorouted, 466 track/via segments |
| DRC errors / unconnected | **0 / 13** |
...
The autorouter left 13 connection(s) open. Each one is a real missing copper
connection and has to be drawn by hand (or designed out) before fabrication:

| # | Net | Class | From | To |
| --- | --- | --- | --- | --- |
| 1 | `+3V3` | POWER | Track on B.Cu, length 2.0776 mm | Track on F.Cu, length 3.2868 mm |
| 2 | `+3V3` | POWER | Track on B.Cu, length 1.6203 mm | Track on B.Cu, length 2.0611 mm |
| 3 | `+3V3` | POWER | Track on B.Cu, length 0.1889 mm | Pad 1 of R3 on B.Cu |
| 4 | `GND` | POWER | Pad 2 of C3 on B.Cu | Via on F.Cu - B.Cu |
| 5 | `GND` | POWER | Pad 2 of C5 on B.Cu | Via on F.Cu - B.Cu |
| 6 | `+5V` | POWER | PTH pad 1 of M1 | Track on F.Cu, length 31.5834 mm |
| 7 | `PUMP_RELAY_SW` | MAINS | PTH pad 2 of K1 | PTH pad 2 of M1 |
| 8 | `SIM_RX` | Default | PTH pad 3 of M1 | Track on F.Cu, length 2.0462 mm |
| 9 | `AC_N` | MAINS | PTH pad 2 of J1 | PTH pad 4 of M1 |
| 10 | `AC_N` | MAINS | PTH pad 2 of PS1 | PTH pad 2 of RV1 |
| 11 | `AC_N` | MAINS | PTH pad 4 of M1 | PTH pad 2 of PS1 |
| 12 | `EN` | Default | Pad 3 of U1 on B.Cu | Pad 2 of R3 on B.Cu |
| 13 | `MAINS_SENSE` | Default | Pad 6 of U1 on B.Cu | Track on B.Cu, length 2.0363 mm |
...
| `K1` | relay | AC_L_FUSED, N$K1.5, PUMP_RELAY_SW | +5V, PUMP_RELAY_COIL |
...
- [x] Copper routing (autorouted, 466 track/via segments)
