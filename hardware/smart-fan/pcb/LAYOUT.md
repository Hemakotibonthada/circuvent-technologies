# Circuvent Smart Fan Regulator - generated PCB layout
...
`cv-fan.kicad_dru` adds the rules a net class cannot express: reinforced
...
```
cd hardware
"<KiCad>/bin/python.exe" gen-pcb.py smart-fan --fab
```
