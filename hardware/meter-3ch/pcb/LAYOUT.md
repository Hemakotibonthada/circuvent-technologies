# Circuvent Energy Meter 3CH - generated PCB layout
...
| | |
| --- | --- |
| Board file | `cv-em3.kicad_pcb` |
| Custom design rules | `cv-em3.kicad_dru` |
| Board size | **67.8 x 91.5 mm** (doc target 60 x 35 mm) |
| Layers | 2 (F.Cu / B.Cu), FR4 1.6 mm, 1 oz Cu |
| Footprints placed | 35 of 35 BOM positions |
| Nets | 32 total, 31 multi-pad (routable) |
| Pads bound to nets | 108 of 108 |
| Net classes | Default=8, MAINS=22, POWER=2 |
| Routing | not run |
...
`cv-em3.kicad_dru` adds the rules a net class cannot express: reinforced
...
- Top and bottom edge bands are reserved for mounting holes, fiducials,
  test points (+3V3, GND) and silkscreen legends.
...
| --- | --- | --- | --- |
| `U10` | dip4 | MTR_GND, SEL_M | GND, SEL_A |
| `U4` | dip4 | CH1_CF_A, CH1_CF_M | CH1_CF, GND |
| `U5` | dip4 | CH1_CF1_A, CH1_CF1_M | CH1_CF1, GND |
| `U6` | dip4 | CH2_CF_A, CH2_CF_M | CH2_CF, GND |
| `U7` | dip4 | CH2_CF1_A, CH2_CF1_M | CH2_CF1, GND |
| `U8` | dip4 | CH3_CF_A, CH3_CF_M | CH3_CF, GND |
| `U9` | dip4 | CH3_CF1_A, CH3_CF1_M | CH3_CF1, GND |
...
```
cd hardware
"<KiCad>/bin/python.exe" gen-pcb.py meter-3ch --fab
```
