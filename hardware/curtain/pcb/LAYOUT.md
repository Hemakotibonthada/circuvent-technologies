# Circuvent Curtain Control - generated PCB layout
...
`cv-curt.kicad_dru` adds the rules a net class cannot express: reinforced
...
```
cd hardware
"<KiCad>/bin/python.exe" gen-pcb.py curtain --fab
```
