# Circuvent AquaGuard - generated PCB layout
...
| Board size | **105.1 x 81.2 mm** (doc target 80 x 60 mm) |
| Layers | 2 (F.Cu / B.Cu), FR4 1.6 mm, 1 oz Cu |
| Footprints placed | 31 of 31 BOM positions |
| Nets | 53 total, 20 multi-pad (routable) |
...
`aquaguard.kicad_dru` adds the rules a net class cannot express: reinforced
...
| # | Net | Class | From | To |
| --- | --- | --- | --- | --- |
| 1 | `AC_L_FUSED` | MAINS | Track on F.Cu, length 13.9555 mm | PTH pad 1 of PS1 |
| 2 | `AC_N` | MAINS | PTH pad 2 of PS1 | PTH pad 2 of RV1 |
| 3 | `MOTOR_RELAY_SW` | MAINS | PTH pad 1 of J2 | PTH pad 3 of K1 |
...
```
cd hardware
"<KiCad>/bin/python.exe" gen-pcb.py water-tank-controller --fab
```
