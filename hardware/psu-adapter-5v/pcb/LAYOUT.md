# Circuvent Adapter 5V 1A - generated PCB layout
...
| | |
| --- | --- |
| Board file | `cv-ad5.kicad_pcb` |
| Custom design rules | `cv-ad5.kicad_dru` |
| Board size | **83.9 x 54.9 mm** (doc target 45 x 25 mm) |
...
`cv-ad5.kicad_dru` adds the rules a net class cannot express: reinforced
...
- Top and bottom edge bands are reserved for mounting holes, fiducials,
  test points (none) and silkscreen legends.
...
```
cd hardware
"<KiCad>/bin/python.exe" gen-pcb.py psu-adapter-5v --fab
```
