# Circuvent Energy Meter 1CH - generated PCB layout
...
| | |
| --- | --- |
| Board file | `cv-em1.kicad_pcb` |
| Custom design rules | `cv-em1.kicad_dru` |
| Board size | **82.6 x 50.4 mm** (doc target 40 x 25 mm) |
| Layers | 2 (F.Cu / B.Cu), FR4 1.6 mm, 1 oz Cu |
| Footprints placed | 18 of 18 BOM positions |
| Nets | 18 total, 17 multi-pad (routable) |
| Pads bound to nets | 51 of 51 |
| Net classes | Default=4, MAINS=12, POWER=2 |
| Routing | not run |
...
`cv-em1.kicad_dru` adds the rules a net class cannot express: reinforced
...
| --- | --- | --- | --- |
| `U2` | dip4 | CH1_CF_A, CH1_CF_M | CH1_CF, GND |
| `U3` | dip4 | CH1_CF1_A, CH1_CF1_M | CH1_CF1, GND |
| `U4` | dip4 | MTR_GND, SEL_M | GND, SEL_A |
...
```
cd hardware
"<KiCad>/bin/python.exe" gen-pcb.py meter-1ch --fab
```
