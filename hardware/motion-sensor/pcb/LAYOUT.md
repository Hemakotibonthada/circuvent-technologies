...
| Nets | 57 total, 10 multi-pad (routable) |
| Pads bound to nets | 114 of 114 |
| Net classes | Default=7, POWER=3 |
| Routing | autorouted, 401 track/via segments |
...
Unused BOM positions with no documented connection (fit as DNP or delete from the BOM): `R5`, `R6`
...
- [x] Copper routing (autorouted, 401 track/via segments)
