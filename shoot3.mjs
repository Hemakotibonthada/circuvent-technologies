...
const SHOTS = [
  { path: "/login",    name: "hrms-login-900b.png",   w: 1440, h: 900 },
  { path: "/login",    name: "hrms-login-800b.png",   w: 1280, h: 800 },
  { path: "/register", name: "hrms-register-900b.png",w: 1440, h: 900 },
];
