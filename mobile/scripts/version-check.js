...
// android/ is gitignored, so on a fresh clone it is generated by prebuild from
// app.json. But once it exists locally it is NOT regenerated, and the APK
// manifest is then stamped from build.gradle — not app.json. Bumping app.json
// alone ships an APK with the old version, which is what happened for 1.5.0.
// These checks are skipped when android/ is absent (fresh clone / CI).
