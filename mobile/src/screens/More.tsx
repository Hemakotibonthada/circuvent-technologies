...
type K = "sensors" | "analytics" | "deviceHub" | "activity" | "maintenance" | "safety" | "security" | "system" | "ai" | "aiFeatures" | "aiModels" | "lifestyle" | "suggestions" | "export" | "mqtt" | "admin" | "schedules" | "profile" | "notifications" | "securitySettings" | "connections" | "backup" | "help" | "about" | "uiKit" | "dashboard" | "charts" | "weather" | "cameras" | "billpay";
const groups: { title: string; items: { key: K; glyph: string; label: string; subtitle: string }[] }[] = [
  ...
  { title: "Tools", items: [{ key: "schedules", glyph: "⏱️", label: "Schedules", subtitle: "Timers & routines" }, { key: "billpay", glyph: "🧾", label: "Pay Bills", subtitle: "Electricity bills" }, { key: "dashboard", glyph: "🧩", label: "Custom Dashboard", subtitle: "Pick widgets" }, { key: "charts", glyph: "📊", label: "Charts & Widgets", subtitle: "Full chart suite" }, { key: "uiKit", glyph: "🎛️", label: "UI Components", subtitle: "Showcase" }] },
