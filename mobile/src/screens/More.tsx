...
import { Card, Screen, SectionLabel, Title, useTheme } from "../ui";
...
type K = "sensors" | "analytics" | "deviceHub" | "activity" | "maintenance" | "safety" | "security" | "system" | "ai" | "aiFeatures" | "aiModels" | "lifestyle" | "suggestions" | "export" | "mqtt" | "admin" | "schedules" | "profile" | "notifications" | "securitySettings" | "connections" | "backup" | "help" | "about" | "uiKit" | "dashboard";
const groups: { title: string; items: { key: K; glyph: string; label: string; subtitle: string }[] }[] = [
  { title: "Monitoring", items: [{ key: "sensors", glyph: "📈", label: "Sensors", subtitle: "Live readings" }, { key: "analytics", glyph: "📊", label: "Analytics", subtitle: "Usage trends" }, { key: "deviceHub", glyph: "🧭", label: "Device Hub", subtitle: "Manage rooms" }, { key: "activity", glyph: "📜", label: "Activity Log", subtitle: "Full timeline" }, { key: "maintenance", glyph: "🩺", label: "Maintenance", subtitle: "Health checks" }] },
  { title: "Tools", items: [{ key: "schedules", glyph: "⏱️", label: "Schedules", subtitle: "Timers & routines" }, { key: "dashboard", glyph: "🧩", label: "Custom Dashboard", subtitle: "Pick widgets" }, { key: "uiKit", glyph: "🎛️", label: "UI Components", subtitle: "Showcase" }] },
  ...
  { title: "Safety & Security", items: [{ key: "safety", glyph: "🚨", label: "Safety Center", subtitle: "SOS & alerts" }, { key: "security", glyph: "🛡️", label: "Security", subtitle: "Arm/disarm" }] },
