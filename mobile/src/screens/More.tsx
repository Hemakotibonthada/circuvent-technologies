...
import Household from "./more/Household";
import Assistants from "./more/Assistants";
...
import Vehicles from "./more/Vehicles";
...
type K = "sensors" | "analytics" | "deviceHub" | "activity" | "maintenance" | "safety" | "security" | "system" | "ai" | "aiFeatures" | "aiModels" | "lifestyle" | "suggestions" | "export" | "mqtt" | "admin" | "schedules" | "profile" | "household" | "assistants" | "notifications" | "securitySettings" | "connections" | "backup" | "help" | "about" | "uiKit" | "dashboard" | "charts" | "weather" | "cameras" | "vehicles" | "billpay" | "voice";
const groups: { title: string; items: { key: K; icon: IconName; label: string; subtitle: string }[] }[] = [
  ...
  { title: "Safety & security", items: [{ key: "cameras", icon: "camera", label: "Cameras", subtitle: "Live IP camera feeds" }, { key: "vehicles", icon: "anpr-cam", label: "Vehicles", subtitle: "Who is on site, and plate history" }, { key: "safety", icon: "sos", label: "Safety center", subtitle: "SOS & alerts" }, { key: "security", icon: "security", label: "Security", subtitle: "Arm/disarm" }] },
  ...
  { title: "Account & settings", items: [{ key: "profile", icon: "profile", label: "Profile", subtitle: "Account summary" }, { key: "household", icon: "profile", label: "Household", subtitle: "Share this home with family" }, { key: "assistants", icon: "voice", label: "Voice assistants", subtitle: "Google Home & Alexa" }, { key: "notifications", icon: "bell", label: "Notifications", subtitle: "Alerts & quiet hours" }, { key: "securitySettings", icon: "shieldLock", label: "Security settings", subtitle: "Lock & sessions" }, { key: "connections", icon: "globe", label: "Connections", subtitle: "API, broker, devices" }, { key: "backup", icon: "backup", label: "Backup", subtitle: "Export account data" }, { key: "help", icon: "help", label: "Help & support", subtitle: "FAQ & contact" }, { key: "about", icon: "about", label: "About", subtitle: "Version & credits" }] },
