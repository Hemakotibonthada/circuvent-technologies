...
export const FLEET_SCREENS: EnterpriseScreen[] = [
  ...
  { key: "fleet-intelligence", title: "Fleet intelligence", subtitle: "Correlated findings: bad releases, site outages, silent devices", icon: "sparkles", group: "Fleet operations", admin: true, render: (p) => <FleetIntelligence onBack={p.onBack} /> },
