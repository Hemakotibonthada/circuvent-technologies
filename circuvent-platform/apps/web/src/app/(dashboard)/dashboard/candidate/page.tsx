...
export default function CandidateDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Welcome Banner */}
      <div className="rounded-xl border border-brand-200 bg-brand-50 p-6 dark:border-brand-500/20 dark:bg-brand-50 dark:bg-brand-500/5">
        <div className="flex items-center gap-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-brand-100 text-2xl dark:bg-brand-200 dark:bg-brand-500/20">🚀</div>
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
              ...
              You can track your application status from the <a href="/careers/my-applications" className="text-brand-600 hover:underline dark:text-brand-600 dark:text-brand-400">My Applications</a> page.
            </p>
          </div>
        </div>
      </div>
      ...
      <Card>
        <div className="mb-4 flex items-center justify-between">
          ...
          <a href="/careers" className="text-xs text-brand-600 hover:underline dark:text-brand-600 dark:text-brand-400">View all →</a>
        </div>
        <div className="space-y-3">
          {openJobs.slice(0, 8).map((job: any) => (
            <a key={job.id} href={`/careers?job=${job.id}`} className="block rounded-lg border border-slate-200 bg-white p-4 shadow-sm transition-all hover:border-brand-300 hover:shadow-md dark:border-slate-700 dark:bg-slate-800/30 dark:hover:border-brand-300 dark:hover:border-brand-500/40 dark:hover:bg-slate-100 dark:hover:bg-slate-800/60">
      ...
      <div className="grid grid-cols-2 gap-3">
        <a href="/careers" className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 text-sm shadow-sm transition-all hover:border-brand-300 hover:shadow-md dark:border-slate-700 dark:bg-slate-800/30 dark:hover:border-brand-300 dark:hover:border-brand-500/50">
        ...
        <a href="/careers/my-applications" className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 text-sm shadow-sm transition-all hover:border-brand-300 hover:shadow-md dark:border-slate-700 dark:bg-slate-800/30 dark:hover:border-brand-300 dark:hover:border-brand-500/50">
          <span className="text-lg">📄</span>
          <div>
