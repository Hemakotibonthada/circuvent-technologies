...
const ONBOARDING_STEPS = [
  { id: "profile", label: "Personal Information", description: "Name, email, phone, and address verified", mandatory: true }, { id: "documents", label: "Identity Documents", description: "PAN card, Aadhaar, and photo ID submitted", mandatory: true }, { id: "bank", label: "Bank Account Details", description: "Bank account number and IFSC for salary credit", mandatory: true }, { id: "pf", label: "PF / UAN Registration", description: "Provident Fund UAN number linked", mandatory: true }, { id: "tax", label: "Tax Declaration", description: "Investment declaration for TDS computation", mandatory: false }, { id: "it_setup", label: "IT Equipment Setup", description: "Laptop, email, Slack, GitHub access provisioned", mandatory: true }, { id: "nda", label: "NDA & Policy Acknowledgment", description: "Non-disclosure and company policy signed", mandatory: true }, { id: "buddy", label: "Buddy Assignment", description: "Onboarding buddy assigned for first 30 days", mandatory: false }, { id: "training", label: "Orientation Training", description: "Company overview, tools, and process training completed", mandatory: false }, { id: "probation", label: "Probation Review", description: "6-month probation period review scheduled", mandatory: true },
];
