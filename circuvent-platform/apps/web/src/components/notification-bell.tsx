  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      <button
        ...
        className="relative rounded-lg p-2 text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-white transition-colors"
      ...
      {/* Dropdown Panel */}
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-96 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-900 shadow-2xl z-50">
          {/* Header */}
                    ...
                    <div className="flex items-start justify-between gap-2">
                      ...
                      {!notification.isRead && (
                        <button
                          ...
                          className="flex-shrink-0 text-xs text-slate-500 hover:text-white"
                          title="Mark as read"
                        >
                          ●
                        </button>
          ...
          <div className="border-t border-slate-200 dark:border-slate-800 px-4 py-2">
            <a href="/notifications" className="block text-center text-xs text-slate-500 hover:text-white transition-colors">
