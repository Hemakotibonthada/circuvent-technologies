...
export const allProjects: ProjectDetail[] = [
  {
    ...
    testimonial: {
      ...
      role: "Founder & CEO, Circuvent Technologies",
    },
    color: "#8b5cf6",
    icon: "🧠",
  },
  {
    ...
    testimonial: {
      quote: "From ESP32 sensor design to cloud analytics — we delivered an end-to-end solution. The MQTT architecture scales beautifully.",
      author: "Vijay Pithani",
      role: "Co-Founder & Head of Electronics, Circuvent Technologies",
    },
    color: "#10b981",
    icon: "🏠",
  },
  ...
  },
  {
    ...
    testimonial: {
      quote: "Replaced traditional HR tools with a single unified platform. Saved thousands in SaaS costs while improving team productivity.",
      author: "Chiru Kotcherla",
      role: "Co-Founder & Marketing Director, Circuvent Technologies",
    },
    color: "#f59e0b",
    icon: "🏢",
  },
