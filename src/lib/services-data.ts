...
export const testimonials: Testimonial[] = [
  {
    ...
    name: "Rajesh Kumar",
    role: "CTO",
    company: "SmartLiving India",
    avatar: "👨‍💼",
    content:
      "Circuvent built our entire smart home IoT platform — from ESP32 firmware to the Flutter app and Alexa integration. The quality of their embedded systems work is exceptional. Our product went from concept to production in 3 months.",
    rating: 5,
  ...
  },
  {
    ...
    avatar: "👩‍⚕️",
    content:
      "The CancerGuard AI system Circuvent built for us has a 94% prediction accuracy. Their ensemble learning approach and HIPAA-aligned architecture gave us confidence to deploy in a healthcare setting. Truly impressive AI engineering.",
    rating: 5,
  ...
  },
  {
    ...
    company: "HT Research Lab",
    avatar: "👨‍💻",
    content:
      "We replaced both Keka and Jira with HT Connect — saving us $2,400/month. The platform handles our 50-person team's HR operations and sprint management flawlessly. 98.5% uptime over 12 months speaks for itself.",
    rating: 5,
  ...
  },
  {
    ...
    avatar: "👩‍💻",
    content:
      "TravelMate is one of the best cross-platform apps we've worked with. Offline maps, real-time translation, Gemini AI integration — all from a single React Native codebase. The Circuvent team delivered on every requirement.",
    rating: 5,
  ...
  },
  {
    ...
    avatar: "📊",
    content:
      "The StockMarket Agent is exactly what I needed — a local-first trading engine with proper walk-forward backtesting. No cloud dependency means my strategies stay private. The DuckDB + Parquet data stack is lightning fast.",
    rating: 5,
  ...
  },
  {
    ...
    avatar: "👩‍🏫",
    content:
      "EduKanban transformed our online learning platform. The AI course generation saves our instructors hours of content creation, and the real-time chat keeps students engaged. The Kanban task management is a unique differentiator.",
    rating: 5,
