...
export const masonryTestimonials = [
  {
    ...
    avatar: "🧑‍💻",
    content: "Circuvent built our entire IoT monitoring platform in 6 weeks. The ESP32 firmware, MQTT backend, and Flutter dashboard work flawlessly. Sub-100ms sensor updates — exactly what we needed.",
    rating: 5,
    featured: true,
  },
  {
    ...
    avatar: "👩‍💼",
    content: "The CancerGuard AI system they built achieves 94.2% detection accuracy. Incredible engineering across both the ML pipeline and the clinical interface.",
    rating: 5,
  },
  {
    name: "Marcus Chen",
    ...
    avatar: "👨‍💼",
    content: "Their algorithmic trading platform handles real-time market data with NPU-accelerated inference. The architecture is enterprise-grade. Highly recommend for FinTech projects.",
    rating: 5,
    featured: true,
  },
  {
  ...
  },
  {
    name: "Ravi Patel",
    role: "Director",
    company: "SmartSpace IoT",
    avatar: "🧑‍🔧",
    content: "From ESP32 sensor design to cloud analytics dashboard — they delivered an end-to-end solution. The MQTT + Firebase architecture scales beautifully.",
    rating: 4,
  },
  {
    name: "Elena Kowalski",
    ...
    company: "DevForge",
    avatar: "👩‍💻",
    content: "Code quality is exceptional. Clean architecture, comprehensive tests, Docker deployment — everything a production system needs. Their open-source contributions are impressive.",
    rating: 5,
    featured: true,
  },
  {
    ...
    avatar: "👨‍💻",
    content: "Replaced our Keka + Jira setup with a single HRMS platform. Saved us thousands in SaaS costs. The system handles everything from attendance to project management.",
    rating: 5,
  },
  {
    name: "Ananya Desai",
    ...
    avatar: "🧑‍🔬",
    content: "Their ML pipeline for cancer detection was meticulously engineered. ChromaDB vector storage, custom model training, and a clean API — all containerized with Docker.",
    rating: 5,
  },
  {
    name: "Tom Nakamura",
