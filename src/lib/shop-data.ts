...
export const products: Product[] = [
  ...
  },
  {
    ...
    tagline: "Sump to overhead, filled automatically — no cable to the roof",
    description:
      "Manages a two-tank system: an underground sump and an overhead tank. The tank unit sits on the overhead tank and reports the level down by long-range radio, so there is no sensor cable to run up the building. The controller starts the pump when the overhead tank runs low, stops it once full, and refuses to run when the sump is empty. If the pump draws current but the level does not rise, it cuts the motor before the pump is damaged. And if the tank unit ever stops reporting, auto-fill pauses rather than pumping on an old reading. Live fill percentage and litres for both tanks in the app.",
    price: 3999,
    compareAt: 4999,
    category: "Water Management",
    ...
    icon: "🛢️",
    specs: [
      "Two units — tank sensor + pump controller",
      "Wireless tank sensor, no cable to the roof",
      "Long-range radio through concrete floors",
      "Battery tank unit, level reported in the app",
      "Auto-fill between set levels",
      "Dry-run trip protects the pump",
      "Overflow float backup",
      "Pauses rather than pumping on a stale reading",
    ],
    stock: 10,
    badge: "New",
    rating: 4.7,
  ...
  {
    id: "touchboard-8",
    slug: "circuvent-touch-switchboard-8",
    name: "Circuvent Touch Switchboard 8",
    tagline: "Eight capacitive gangs with per-board energy metering",
    description:
      "A wall switchboard with eight capacitive touch pads driving eight relays, for the room where three gangs were never going to be enough. Every pad works by touch whether or not the network is up. A dimmable LED backlight makes them easy to find at night, and built-in metering reports voltage, current, power, power factor and cumulative units for the whole board. Bulk switching is staggered so turning everything on does not brown out the board.",
    price: 5499,
    compareAt: 6799,
    category: "Home Automation",
    image: "/img/product-touchboard-8.svg",
    accent: "#2dd4bf",
    icon: "🎛️",
    specs: [
      "8 capacitive touch gangs",
      "Dimmable LED backlight",
      "Voltage, current & power metering",
      "Power factor + kWh totals",
      "Local touch works offline",
      "Staggered bulk switching",
      "App, scenes & schedules",
    ],
    stock: 8,
    rating: 4.6,
