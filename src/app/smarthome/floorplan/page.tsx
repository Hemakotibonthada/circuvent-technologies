      ...
      {active && activeStatus && (
        <div className="mt-4 rounded-2xl border border-white/10 bg-black/20 p-4">
          <div className="flex items-center justify-between">
            ...
            <a href={`/smarthome/device/${encodeURIComponent(active.id)}`} className="rounded-lg border border-white/15 px-3 py-1.5 text-sm text-white hover:bg-white/10">Open controls</a>
          </div>
